  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] hover:border-[#1D1D1D] rounded-[14px] p-5 transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wider">Current Balance</span>
            <DollarSign className="w-4 h-4 text-[#FF7A00]" />
          </div>
          <div className="text-2xl font-bold text-white font-mono tracking-tight">
            {riskSettings.currencySymbol}{stats.currentBalance.toLocaleString()}
          </div>
          <div className="text-[11px] text-[#8B8B8B] mt-1">
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] hover:border-[#1D1D1D] rounded-[14px] p-5 transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wider">Total Trades</span>
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] hover:border-[#1D1D1D] rounded-[14px] p-5 transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wider">Win Rate</span>
            <Target className="w-4 h-4 text-[#4CAF50]" />
          </div>
          <div className="text-2xl font-bold text-[#4CAF50] font-mono tracking-tight">
            {stats.winRate}%
          </div>
          <div className="text-[11px] text-[#8B8B8B] mt-1">
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] hover:border-[#1D1D1D] rounded-[14px] p-5 transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wider">Net Profit</span>
            <TrendingUp className={`w-4 h-4 ${stats.netProfit >= 0 ? 'text-[#4CAF50]' : 'text-[#FF7A00]'}`} />
          </div>
          <div className={`text-2xl font-bold font-mono tracking-tight ${stats.netProfit >= 0 ? 'text-[#4CAF50]' : 'text-[#FF7A00]'}`}>
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] hover:border-[#1D1D1D] rounded-[14px] p-5 transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wider">Current Drawdown</span>
            <ShieldAlert className="w-4 h-4 text-[#FF7A00]" />
          </div>
          <div className="text-2xl font-bold text-[#FF7A00] font-mono tracking-tight">
            {stats.currentDrawdown}%
          </div>
          <div className="text-[11px] text-[#8B8B8B] mt-1">
            Max Peak DD: {stats.maxDrawdown}%
          </div>
        </div>
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] hover:border-[#1D1D1D] rounded-[14px] p-5 transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wider">Profit Factor</span>
            <Scale className="w-4 h-4 text-[#FFB366]" />
          </div>
          <div className="text-2xl font-bold text-white font-mono tracking-tight">
            {stats.profitFactor}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#151515] border border-[#2D2D2D] rounded-[14px] p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Account Equity Curve</h3>
              <p className="text-xs text-[#8B8B8B]">Cumulative account growth trajectory</p>
            </div>
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={equityData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: '#111111', borderColor: '#2D2D2D', borderRadius: '8px', color: '#fff' }}
        ...
        <div className="bg-[#151515] border border-[#2D2D2D] rounded-[14px] p-5 flex flex-col justify-between">
          <div>
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-1">Win vs Loss Ratio</h3>
            <p className="text-xs text-[#8B8B8B] mb-4">Distribution of completed trades</p>
          </div>
          <div className="h-52 w-full relative flex items-center justify-center">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip contentStyle={{ backgroundColor: '#111111', borderColor: '#2D2D2D', borderRadius: '8px', color: '#fff' }} />
              </PieChart>
            </ResponsiveContainer>
            <div className="absolute text-center">
              <span className="text-2xl font-bold text-white">{stats.winRate}%</span>
              <span className="block text-[10px] text-[#8B8B8B] uppercase">Win Rate</span>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-2 pt-3 border-t border-[#2D2D2D] text-center text-xs">
            <div>
              <span className="text-[#4CAF50] font-bold block">{winCount}</span>
              <span className="text-[#8B8B8B] text-[10px]">WINS</span>
            </div>
            <div>
              <span className="text-[#FF7A00] font-bold block">{lossCount}</span>
              <span className="text-[#8B8B8B] text-[10px]">LOSSES</span>
            </div>
            <div>
              <span className="text-[#808080] font-bold block">{beCount}</span>
              <span className="text-[#8B8B8B] text-[10px]">BREAK EVEN</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#151515] border border-[#2D2D2D] rounded-[14px] p-5">
        <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-1">Monthly PNL Performance</h3>
        <p className="text-xs text-[#8B8B8B] mb-4">Net profit or loss grouped by month</p>
      ...
      <div className="bg-[#151515] border border-[#2D2D2D] rounded-[14px] p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-sm font-bold text-white uppercase tracking-wider">Recent Executed Trades</h3>
            <p className="text-xs text-[#8B8B8B]">Latest 10 logged trade positions</p>
          </div>
          <button
            onClick={() => onNavigate('journal')}
            className="flex items-center gap-1.5 px-4 py-2 bg-[#202020] hover:bg-[#2D2D2D] text-white text-xs font-semibold rounded-lg transition-colors border border-[#343434]"
          >
            ...
            <tbody className="divide-y divide-[#2D2D2D]">
              {recentTrades.map((t) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-[#B8B8B8]">{t.date}</td>
                  ...
                  <td className="py-3 px-4 text-white font-mono">1 : {t.rr}</td>
                  <td className={`py-3 px-4 font-mono font-bold ${t.pnl >= 0 ? 'text-[#4CAF50]' : 'text-[#FF7A00]'}`}>
